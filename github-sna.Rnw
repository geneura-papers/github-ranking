...
%  parts of the last ten years. 
  ...
  bloggers~\cite{weblogs-JNCA}; we now study communities of developres, creating
  GitHub rankings for many Spanish cities
  \cite{10.15200/winn.142251.14740}. These studies tends to induce
...
\begin{figure}[htb]
  \centering
<<zipf, echo=FALSE, out.width='.49\\linewidth', fig.height=2, fig.subcap=c('Contributions', 'Users')>>=
