...
Notice also that all the projects in GitHub can not be considered FLOSS as we can see at: `Study: Most projects on GitHub not open source licensed.'\footnote{http://www.theregister.co.uk/2013/04/18/github\_licensing\_study/}, `Licensing of Software on Github:
A Quantitative Analysis'\footnote{\url{http://www.softwarefreedom.org/resources/2013/lcs-slides-aaronw/}}. %If this fits well here I'll try to improve references.
