...
\author{JJ Merelo\thanks{GeNeura Team and Free Software Office, University of Granada}, Israel Blancas\thanks{University of Granada}, M. G. Arenas \thanks{University of Granada}}
...
is involved in the creation of open source projects. However, the only % quito software porque algunos projectos no son solo software
way of finding out who was is to make them come to any of our events
or contact us through any means.

So the initial intention for creating a ranking of FLOSS (Free/Libre/Open/Source Software)
was to know who is out there and the kind of things they are doing, be
them part of the academic world or they belong to the business one; creating a census would allow us
...
users that previously had not known each other. We discovered that
...
Some other web-based \it{repos} do have many of the characteristics, and,
...
equal (Madrid) to most equalitarian, Valencia. However, there is no
big range of variation, hovering around 0.70, which is way over the
inequality of the most inequal country in the world, the
...
\begin{figure}[htb]
  \centering
<<avg, echo=FALSE, fig.height=6, fig.width=8>>=
...
\begin{figure}[htb]
  \centering
<<impact, echo=FALSE, fig.height=6, fig.width=8>>=
...
have {\em increased} the number of active users after difussion,
